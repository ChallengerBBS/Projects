namespace PetStore.Services.Implementations
{
    ...
    public class BrandService : IBrandService
    {
        ...
        private readonly PetStore.Data.PetStoreDbContext data;
        ...
        public int Create(string name)
        {
            ...
            {
                throw new InvalidOperationException($"Brand name cannot exceed {DataValidation.NameMaxLength} characters !");
            }

            if (data.Brands.Any(b => b.Name == name))
            {
