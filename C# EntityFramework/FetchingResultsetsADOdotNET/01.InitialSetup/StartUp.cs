        ...
        static void Main(string[] args)
        {
            ...
            using (connection)
            {
                try
                {
                    ...
                    SqlCommand createTableSMD = new SqlCommand(queryText, connection);
                    createTableSMD.ExecuteNonQuery();
                ...
                {
                    Console.WriteLine("There was problem with the tables");
                    Console.WriteLine(e.Message);
                }
